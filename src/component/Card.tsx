...
const Card = (props: CardInfo) => {
  ...
  return (
    <div className='min-w-[15.4rem] first:ml-8 hover:cursor-pointer min-h-[18.7rem] mx-4 shadow-md mb-8 my-2 sm:min-h-[25.7rem] sm:min-w-[22.4rem] active:translate-y-4 active:scale-105 transition-all '>
