...
const GalleryPicture = (props: Picture): JSX.Element => {
  ...
  switch (index) {
    case 0:
      imgContCondFormat =
        'sm:h-full sm:w-full sm:row-[span_8] sm:col-span-3 lg:row-span-4 lg:col-span-2'
      break

    case 1:
      imgContCondFormat =
        'sm:h-full sm:w-full sm:row-[span_10] sm:col-span-1 lg:row-span-4 lg:col-span-2'
      break

    case 2:
      imgContCondFormat =
        'sm:w-full sm:h-full sm:row-span-5 sm:col-span-2 lg:row-span-4'
      break
  ...
  return (
    <div className={`relative rounded-lg h-[30rem] ${imgContCondFormat}`}>
      ...
      <p className="absolute mx-4 font-sans text-2xl text-white top-16">
        {subtitle}
      </p>
    </div>
  )
